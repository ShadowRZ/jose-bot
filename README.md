# Jose Bot [![Built with matrix-nio](https://img.shields.io/badge/built%20with-matrix--nio-brightgreen)](https://github.com/poljar/matrix-nio)

Matrix bot for implmenting join confirmation. Named after [Jose](https://megamitensei.fandom.com/wiki/Jose).
...
The majority of the code is kept inside of the `jose_bot` folder, which
...
To run the bot, the `jose-bot` script in the root of the codebase is
